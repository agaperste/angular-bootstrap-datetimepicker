...
describe('DlDateTimePickerComponent maxView', () => {
  ...
  describe('year', () => {
    ...
    it('should not have an .up-button', () => {
      fixture.debugElement.query(By.css('.up-button')).nativeElement.click();  // to go month-view
      fixture.detectChanges();

      fixture.debugElement.query(By.css('.up-button')).nativeElement.click();  // go to year-view
      fixture.detectChanges();
  ...
  describe('month', () => {
    ...
    it('should not have an .up-button', () => {
      fixture.debugElement.query(By.css('.up-button')).nativeElement.click();  // go to month-view
      fixture.detectChanges();
      const upButton = fixture.debugElement.query(By.css('.up-button'));
      expect(upButton).toBeFalsy();
    });
